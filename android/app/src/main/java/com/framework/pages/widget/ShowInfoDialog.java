...
public class ShowInfoDialog extends Dialog {
    ...
    public ShowInfoDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public ShowInfoDialog.Builder setMessage(String message) {
         ...
         * @return
         */
        public ShowInfoDialog.Builder setMessage(int message) {
         ...
         * @return
         */
        public ShowInfoDialog.Builder setTitle(int title) {
        ...
        public ShowInfoDialog.Builder setTitle(String title) {
            this.title = title;
            return this;
        }

        public ShowInfoDialog.Builder setContentView(View v) {
            this.contentView = v;
            return this;
        }
